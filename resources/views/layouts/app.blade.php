                    ...
                    <div class="modal-body">
                      ...
                      <div class="mb-3">
                        ...
                        <select name="id_projek" class="form-control">
                          ...
                          @foreach($projek as $p)
                            <option value="{{ $p->id_projek }}" {{ old('id_projek') == $p->id_projek ? 'selected' : '' }}>
                              {{ $p->nama_projek }}
                            </option>
                          @endforeach
                        </select>
                          ...
                          <td class="text-center">
                            <div class="btn-group btn-group-sm">
                              ...
                              <button type="button" class="btn btn-outline-primary border-0 btn-edit"
                                data-bs-toggle="modal" data-bs-target="#modalEdit" data-id="{{ $s->id_site }}"
                                data-projek="{{ $s->id_projek }}" data-alamat="{{ $s->alamat }}"
                                data-lat="{{ $s->latitude }}" data-lng="{{ $s->longitude }}"
                                data-ip="{{ $s->ip_address }}" data-note="{{ $s->note }}"
          ...
          <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow">
              ...
              <div class="modal-header bg-primary">
                <h5 class="modal-title text-white">Edit Site Details</h5>
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      <label>Proyek</label>
                      <select name="id_projek" id="edit-projek" class="form-control">
                        @foreach($projek as $p)
          ...
          document.addEventListener('DOMContentLoaded', function () {
            ...
            editButtons.forEach(btn => {
              btn.addEventListener('click', function () {
                ...
                formEdit.action = `/sites/${this.dataset.id}`;

                document.getElementById('edit-projek').value = this.dataset.projek;
