                                            ...
                                            <tr id="site-row-{{ $s->id_site }}">
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group btn-group-sm">
                                                        <button type="button"
                                                            class="btn btn-outline-primary border-0 btn-edit-trigger"
                                                            data-id="{{ $s->id_site }}"
                                                        ...
                                                        <script>
                                                            document.addEventListener('click', function (e) {
                                                                ...
                                                                if (btn) {
                                                                    // Debugging: Cek di console browser apakah data muncul saat diklik
                                                                    console.log("Data Alamat:", btn.dataset
                                                                        .alamat);
                                                                    console.log("Data IP:", btn.dataset.ip);

                                                                    const modalEl = document.getElementById(
                                                                        'modalEdit');

                                                                    // Simpan koordinat untuk Map
                                                                    modalEl.dataset.lat = btn.dataset.lat;
                                                                    modalEl.dataset.lng = btn.dataset.lng;

                                                                    // Set form action (sesuaikan dengan route update kamu)
                                                                    ...
                                                                    if (document.getElementById(
                                                                        ...
                                                                        document.getElementById(
                                                                            'edit-id-projek').value = btn
                                                                        .dataset.projek_id;

                                                                    if (document.getElementById(
                                                                            'edit-projek-manual'))
                                                                        document.getElementById(
                                                                            'edit-projek-manual').value = btn
                                                                        .dataset.projek_val;

                                                                    if (document.getElementById('edit-ip'))
                                                                        document.getElementById('edit-ip')
                                                                        .value = btn.dataset.ip;

                                                                    if (document.getElementById('edit-alamat'))
                                                                        document.getElementById('edit-alamat')
                                                                        .value = btn.dataset.alamat;

                                                                    if (document.getElementById('edit-tgl'))
                                                                        document.getElementById('edit-tgl')
                                                                        .value = btn.dataset.tgl;

                                                                    if (document.getElementById('edit-note'))
                                                                        document.getElementById('edit-note')
                                                                        .value = btn.dataset.note;

                                                                    if (document.getElementById('edit-lat'))
                                                                        document.getElementById('edit-lat')
                                                                        .value = btn.dataset.lat;

                                                                    if (document.getElementById('edit-lng'))
                                                                        document.getElementById('edit-lng')
                                                                        .value = btn.dataset.lng;

                                                                    // Reset baseProjectNameEdit agar fungsi auto-fill sinkron kembali
                                                                    baseProjectNameEdit = btn.dataset.projek_val
                                                                        .split(' ')[0];
                                                                }
                                                            });
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <select name="id_projek" id="edit-id-projek" class="form-control">
                                            <option value="">Pilih Projek</option>
                                            @foreach($projek as $p)
                                            <option value="{{ $p->id_projek }}" data-nama="{{ $p->nama_projek }}"
                                                {{ old('id_projek') == $p->id_projek ? 'selected' : '' }}>
                                                {{ $p->nama_projek }}
                                            </option>
                                            @endforeach
